...
## 4. TABLE 1: SUMMARY STATISTICS WITH P-VALUES (OLD)
## 5. TABLE 2: QOL BY DIETARY INDEX AND PATTERNS WITH P-VALUES
## 6. PLOTS: QOL BY DIETARY INDEX AND PATTERNS WITH P-VALUES 
...
setwd("C:/Users/Siobhan Brushett/OneDrive - UMCG/Prolepsis_internship/merged_2015_2018/bmi_sds/")
bmi_sds <- read.delim("2023_03_07_bmi_WHO_sds_with_cutoffs.txt", sep = "\t", header = T, stringsAsFactors = T)
str(bmi_sds)
#5056  3

        #predictors: dietary diversity 
#setwd("C:/Users/Siobhan Brushett/OneDrive - UMCG/Prolepsis_internship/merged_2015_2018/dietary_patterns_ffq/food_diversity_index/")
...
str(ffq_diet_score)
        ...
        #outcome: Q15 and Q25
setwd("C:/Users/Siobhan Brushett/OneDrive - UMCG/Prolepsis_internship/merged_2015_2018/summary_statistics/ffq_by_qol_quartiles_dich/")
...
prop.table(table(masterfile$family_FAS_group_dic, useNA="ifany"))*100
        ...
        #### =============== 2. TIDY MASTERFILE   ================ ####
setwd("C:/Users/Siobhan Brushett/OneDrive - UMCG/Prolepsis_internship/merged_2015_2018/masterfile/")
...
setwd("C:/Users/Siobhan Brushett/OneDrive - UMCG/Prolepsis_internship/merged_2015_2018/masterfile/0_derive_and_tidy_masterfile_sum_stats/")
...
phy_activity <- c("child_phyact_exercise_hrs_per_wk", "child_phyact_screen_time_hrs_per_wk")
phy_activity <- which(colnames(masterfile_sumstats) %in% phy_activity) 

for (i in phy_activity){
        print(table(masterfile_sumstats[,i], useNA = "ifany"))
        masterfile_sumstats[,i] <- recode_factor(masterfile_sumstats[,i], 
                                          "0_hrs_week_0_1"="0.5",
                                          "1_hrs_week_1_2"="1.5",
                                          "2_hrs_week_2_4"="3",
                                          "3_hrs_week_4_6"="5",
                                          "4_hrs_week_6_8"="7",
                                          "5_hrs_week_8_10"="9",
                                          "6_hrs_week_more_than_10"="10",
                                          .ordered=T)
        masterfile_sumstats[,i] <- as.numeric(as.character(masterfile_sumstats[,i])) 
        print(table(masterfile_sumstats[,i], useNA="ifany"))}
        
        ####4.1. Q15: numeric values ####
...
#HRQoL: Q15 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_health_related_qol_score_total_catg_Q15, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_health_related_qol_score_total_catg_Q15, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_health_related_qol_score_total_catg_Q15, data=masterfile_sumstats)
...
#psysoc: Q15 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_psysoc_score_catg_Q15, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_psysoc_score_catg_Q15, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_psysoc_score_catg_Q15, data=masterfile_sumstats)
...
#phy: Q15 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_phy_score_catg_Q15, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_phy_score_catg_Q15, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_phy_score_catg_Q15, data=masterfile_sumstats)
...
#emo: Q15 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_emo_score_catg_Q15, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_emo_score_catg_Q15, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_emo_score_catg_Q15, data=masterfile_sumstats)
...
#soc: Q15 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_soc_score_catg_Q15, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_soc_score_catg_Q15, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_soc_score_catg_Q15, data=masterfile_sumstats)
...
#sch: Q15 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_sch_score_catg_Q15, data=masterfile_sumstats)
x$p.value
x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_sch_score_catg_Q15, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_sch_score_catg_Q15, data=masterfile_sumstats)

        ####4.2. Q15: categorical values ####

#HRQoL: Q15 summary stats
HRQoL_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_health_related_qol_score_total_catg_Q15,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
HRQoL_immigrant <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_health_related_qol_score_total_catg_Q15,
                                 child_demo_immigrant_status,
                                 chisq=T,
                                 prop.r=T,
...
HRQoL_parent_emply <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_health_related_qol_score_total_catg_Q15,
                                 parent_demo_employment,
                                 chisq=T,
                                 prop.r=T,
...
HRQoL_father_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_health_related_qol_score_total_catg_Q15,
                                 father_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
HRQoL_mother_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_health_related_qol_score_total_catg_Q15,
                                 mother_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
#psysoc: Q15 summary stats
psysoc_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
psysoc_bmi <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 child_anthro_bmi_WHO_sds_grouped,
                                 chisq=T,
                                 prop.r=T,
...
psysoc_immigrant <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 child_demo_immigrant_status,
                                 chisq=T,
                                 prop.r=T,
...
psysoc_parent_emply <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 parent_demo_employment,
                                 chisq=T,
                                 prop.r=T,
...
psysoc_father_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 father_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
psysoc_mother_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 mother_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
psysoc_FAS <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q15,
                                 family_demo_FAS_group,
                                 chisq=T,
                                 prop.r=T,
...
#phy: Q15 summary stats
phy_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_phy_score_catg_Q15,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
phy_immigrant <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_phy_score_catg_Q15,
                                 child_demo_immigrant_status,
                                 chisq=T,
                                 prop.r=T,
...
phy_parent_emply <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_phy_score_catg_Q15,
                                 parent_demo_employment,
                                 chisq=T,
                                 prop.r=T,
...
phy_father_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_phy_score_catg_Q15,
                                 father_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
phy_mother_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_phy_score_catg_Q15,
                                 mother_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
#emo: Q15 summary stats
emo_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_emo_score_catg_Q15,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
emo_immigrant <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_emo_score_catg_Q15,
                                 child_demo_immigrant_status,
                                 chisq=T,
                                 prop.r=T,
...
emo_parent_emply <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_emo_score_catg_Q15,
                                 parent_demo_employment,
                                 chisq=T,
                                 prop.r=T,
...
emo_father_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_emo_score_catg_Q15,
                                 father_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
emo_mother_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_emo_score_catg_Q15,
                                 mother_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
#soc: Q15 summary stats
soc_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_soc_score_catg_Q15,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
soc_immigrant <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_soc_score_catg_Q15,
                                 child_demo_immigrant_status,
                                 chisq=T,
                                 prop.r=T,
...
soc_parent_emply <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_soc_score_catg_Q15,
                                 parent_demo_employment,
                                 chisq=T,
                                 prop.r=T,
...
soc_father_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_soc_score_catg_Q15,
                                 father_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
soc_mother_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_soc_score_catg_Q15,
                                 mother_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
#sch: Q15 summary stats
sch_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_sch_score_catg_Q15,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
sch_immigrant <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_sch_score_catg_Q15,
                                 child_demo_immigrant_status,
                                 chisq=T,
                                 prop.r=T,
...
sch_parent_emply <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_sch_score_catg_Q15,
                                 parent_demo_employment,
                                 chisq=T,
                                 prop.r=T,
...
sch_father_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_sch_score_catg_Q15,
                                 father_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
sch_mother_edu <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_sch_score_catg_Q15,
                                 mother_demo_edu,
                                 chisq=T,
                                 prop.r=T,
...
#HRQoL: Q25 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_health_related_qol_score_total_catg_Q25, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_health_related_qol_score_total_catg_Q25, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_health_related_qol_score_total_catg_Q25, data=masterfile_sumstats)
...
#psysoc: Q25 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_psysoc_score_catg_Q25, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_psysoc_score_catg_Q25, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_psysoc_score_catg_Q25, data=masterfile_sumstats)
...
#phy: Q25 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_phy_score_catg_Q25, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_phy_score_catg_Q25, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_phy_score_catg_Q25, data=masterfile_sumstats)
...
#emo: Q25 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_emo_score_catg_Q25, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_emo_score_catg_Q25, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_emo_score_catg_Q25, data=masterfile_sumstats)
...
#soc: Q25 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_soc_score_catg_Q25, data=masterfile_sumstats)
x$p.value

x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_soc_score_catg_Q25, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_soc_score_catg_Q25, data=masterfile_sumstats)
...
#sch: Q25 p-values
x <- t.test(child_demo_age_years ~ child_pedsql_sch_score_catg_Q25, data=masterfile_sumstats)
x$p.value
x <- wilcox.test(child_phyact_exercise_hrs_per_wk ~ child_pedsql_sch_score_catg_Q25, data=masterfile_sumstats)
x$p.value
wilcox.test(child_phyact_screen_time_hrs_per_wk ~ child_pedsql_sch_score_catg_Q25, data=masterfile_sumstats)

        ####4.4. Q25: categorical values ####

#HRQoL: Q25 summary stats
HRQoL_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_health_related_qol_score_total_catg_Q25,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
#psysoc: Q25 summary stats
psysoc_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_psysoc_score_catg_Q25,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
#phy: Q25 summary stats
phy_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_phy_score_catg_Q25,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
#emo: Q25 summary stats
emo_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_emo_score_catg_Q25,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
#soc: Q25 summary stats
soc_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_soc_score_catg_Q25,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
#sch: Q25 summary stats
sch_sex <- masterfile_sumstats %>%
        with(gmodels::CrossTable(child_pedsql_sch_score_catg_Q25,
                                 child_demo_sex,
                                 chisq=T,
                                 prop.r=T,
                                 prop.t=T,
...
IQR(masterfile_sumstats$child_ffq_pattern_5_starchy_foods_sweetened_bev, na.rm=T)
        ...
        ####5.1. QoL (Q15) by dietary quality index ####
...
wilcox.test(child_ffq_pattern_5_starchy_foods_sweetened_bev ~ child_pedsql_sch_score_catg_Q15, data=masterfile_sumstats)
        ...
        ####5.2. QoL (Q25) by dietary quality index ####
#HRQoL: Q25 summary stats
hrqol_numeric <- masterfile_sumstats %>%
        filter(is.na(child_pedsql_health_related_qol_score_total_catg_Q25) == F) %>%
        group_by(child_pedsql_health_related_qol_score_total_catg_Q25) %>%
...
###      use current basis below to adjust and add code accordingly (when needed)
        ...
        ####6.1. plots: QoL (Q15) by dietary quality index ####
...
dev.off()
        ...
        ####6.2. plots: QoL (Q15) by dietary patterns ####
